...
void mixTable() {
  ...
  #elif defined( QUADP )
    #if defined(MULTIWII3D)
      motor[0] = PIDMIX( 0,+1/2,-1/2); //REAR
      motor[1] = PIDMIX(-1/2, 0,+1/2); //RIGHT
      motor[2] = PIDMIX(+1/2, 0,+1/2); //LEFT
      motor[3] = PIDMIX( 0,-1/2,-1/2); //FRONT
    #else
  ...
  #elif defined( Y4 )
    #if defined(MULTIWII3D)
      motor[0] = PIDMIX(+0,+1/2,-1/2); //REAR_1 CW
      motor[1] = PIDMIX(-1/2,-1/2, 0); //FRONT_R CCW
      motor[2] = PIDMIX(+0,+1/2,+1/2); //REAR_2 CCW
      motor[3] = PIDMIX(+1/2,-1/2, 0); //FRONT_L CW
    #else
  ...
  #elif defined( VTAIL4 )
    #if defined(MULTIWII3D)
      motor[0] = PIDMIX(+0, +1/2, +1/2); //REAR_R
      motor[1] = PIDMIX(-1/2, -1/2, +0); //FRONT_R
      motor[2] = PIDMIX(+0, +1/2, -1/2); //REAR_L
      motor[3] = PIDMIX(+1/2, -1/2, -0); //FRONT_L
    #else

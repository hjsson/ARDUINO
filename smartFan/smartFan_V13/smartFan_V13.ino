         ...
         * 
         * 2019.05.04      *V13 CALIBRATION LOGIC CHANGED.                 
         *                 - SOME BUG FIX (Fan Start)
         *                 - Logic change. (HIGH SPEED --> LOW SPEED, 3sec after low value setting)
        */
        ...
        #define speedCAL      120       // FAN CALIBRATION SPEED value. 
...
//        int  testCNT        = 0;
        ...
        void setup(){
                  ...
                  Serial.println("smartFAN controller V13.00....... ");
                  ...
                  if(digitalRead(P_UPPERN) == HIGH){ //상판에 조립된 경우
                        ...
                        delay(1000);
                        analogWrite(P_B_FAN_PWM,  255);
                        delay(1500);
                        analogWrite(P_F_FAN_PWM,  speedCAL);
                        analogWrite(P_B_FAN_PWM,  speedCAL);

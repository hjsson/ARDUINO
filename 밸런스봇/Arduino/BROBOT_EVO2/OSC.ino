...
void OSC_MsgRead()
{
  ...
  if (Serial1.available() > 0) {
    ...
    //Serial.print(UDPBuffer[1]);
    //Serial.print(UDPBuffer[2]);
    //Serial.print(UDPBuffer[3]);
    //Serial.print(UDPBuffer[4]);
    //Serial.print(UDPBuffer[5]);
    //Serial.print(UDPBuffer[6]);
    //Serial.println(UDPBuffer[7]);
